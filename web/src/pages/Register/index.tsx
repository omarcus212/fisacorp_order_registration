...
import TextTittle from "../../components/shared/Text";
...
const PageRegister: React.FC = () => {
    ...
    return (
        <Section className="flex items-center justify-center bg-[#1E6388]">
            <ModalHome>
                <TextTittle text="Cadastro de Pedidos" className="flex items-center justify-center text-xl font-medium font-inter text-black" />
